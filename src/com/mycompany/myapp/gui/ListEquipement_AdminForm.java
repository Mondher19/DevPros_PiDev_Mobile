 ...
 * @author Raef
 */
public class ListEquipement_AdminForm extends SideMenuBaseForm {

    Resources theme;
    Form current;

    public ListEquipement_AdminForm(Form previous) {
...
//        fab.getAllStyles().setMarginUnit(Style.UNIT_TYPE_PIXELS);
  //      fab.getAllStyles().setMargin(BOTTOM, completedTasks.getPreferredH() - fab.getPreferredH() / 2);
        ...
        for (Equipement p : ServiceEquipement.getInstance().getAllEquipements()) {
