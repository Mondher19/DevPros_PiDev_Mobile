 ...
 * @author eyaam
 */
public class AjouterTypeT extends SideMenuBaseForm {
    Form current;
    public AjouterTypeT(Resources res) {
     ...
     //   super.addSideMenu(res);
       ...
       Tabs swipe = new Tabs();
        ...
        addTab(swipe,s1,res.getImage("resv1.png"),"","",res);
       ...
       TextField objet = new TextField("", "entrer un type!!");
            ...
            try {
                ...
                if(objet.getText().equals("") || description.getText().equals("")) {
                    ...
                    final Dialog iDialog = ip.showInfiniteBlocking();
                     ...
                     TypeTournoi r = new TypeTournoi(String.valueOf(objet.getText()
                                  ).toString(),
                    ...
                    ServiceTypeT.getInstance().ajoutTour(r);
                    
                    iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
                    
                    //ba3d ajout net3adaw lel ListREclamationForm
                    new ListTypeT(res).show();
